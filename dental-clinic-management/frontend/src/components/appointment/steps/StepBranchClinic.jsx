...
const StepBranchClinic = ({ branches = [], isLoading, error, onChange, appointmentData = {} }) => {
  console.log('StepBranchClinic Props:', { appointmentData, branches });
        ...
        {branches.map((branch) => (
          <div
            ...
            className={`border rounded-lg p-4 cursor-pointer transition-all hover:shadow-md flex flex-col ${
              appointmentData?.branchClinic?.id === branch.id
